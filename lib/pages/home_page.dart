...
class _HomePageState extends State<HomePage> {
  ...
  String _statusFilter = 'publicado'; // ADAPTADO: tu BD usa 'publicado' como default
  ...
  Future<void> _loadPets() async {
    ...
    try {
      // ADAPTADO: Cargar pets con fotos de la tabla pet_photos
      var query = _sb
          .from('pets')
          .select('''
            *,
...
class _PetCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final municipio = pet['municipio'] as String? ?? 'Colombia'; // ADAPTADO
    final estado = pet['estado'] as String? ?? 'publicado';
    
    // ADAPTADO: Obtener primera foto de pet_photos
    ...
    if (petPhotos != null && petPhotos.isNotEmpty) {
      ...
      imageUrl = sortedPhotos.first['url'] as String?;
    }
