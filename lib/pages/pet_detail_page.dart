  ...
  Future<void> _markFoundAndAskDelete() async {
    ...
    try {
      if (sel == _FoundAction.deleteNow) {
        ...
        await _load();
        if (!mounted) return;
        _showSuccessDialog(isFound: true);
      }
    } catch (e) {
      if (!mounted) return;
      ScaffoldMessenger.of(context)
      ...
      builder: (_) => Dialog(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Image.asset(
                'assets/logo/petfyco_icon.png', 
                height: 80, 
                errorBuilder: (_, __, ___) => const Icon(Icons.celebration, size: 80, color: AppColors.orange)
              ),
              ...
              const SizedBox(height: 16),
              Text(
                '¡$name fue $action! Gracias a todos nuestros héroes de patitas de PetfyCo. Su apoyo marca la diferencia.',
                textAlign: TextAlign.center,
